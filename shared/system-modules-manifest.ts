...
export const SYSTEM_MODULES_MANIFEST: SystemModuleDefinition[] = [
  ...
  { name: "sales_planning", displayName: "Sales Planning", description: "Weekly targets, monthly goals, and performance tracking", icon: "CalendarRange", sortOrder: 4, parentModule: "leads" },
  { name: "extractor", displayName: "Google Maps Extractor", description: "Extract business data from Google Maps for lead generation", icon: "MapPin", sortOrder: 5, parentModule: "leads" },
  { name: "quotes", displayName: "Quotes", description: "Quote generation and management", icon: "FileText", sortOrder: 6, parentModule: "leads" },
